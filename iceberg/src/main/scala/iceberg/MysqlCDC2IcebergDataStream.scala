...
// * @date 2022/6/9
// */
//object MysqlCDC2IcebergDataStream {
//
//
//  // =========获取Mysql CDC的流数据==========
...
//      .tableList("shop-service-test.test2")
...
//          val org_name = afterOrAfterJsonObject.getString("name")
//          //          val create_time = afterOrAfterJsonObject.getLong("create_time")
//
//          val rowData: GenericRowData = new GenericRowData(2)
//          // 指定数据的导入类型
...
//    hiveCatalogProperties.put("warehouse", "hdfs://ns1/hive/warehouse/iceberg_hadoop_db/test2")
//    hiveCatalogProperties.put("uri", "thrift://192-168-80-52:9083")
...
//    )
//
//    hiveCatalog.createNamespace(Namespace.of("ice_test"))
//
...
//    val hiveCatalogTableName: TableIdentifier = TableIdentifier.of("db", "ice_test")
