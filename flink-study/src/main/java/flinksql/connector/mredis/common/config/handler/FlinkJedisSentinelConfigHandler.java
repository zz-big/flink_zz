...
package flinksql.connector.mredis.common.config.handler;

import flinksql.connector.mredis.common.config.FlinkJedisConfigBase;
import flinksql.connector.mredis.common.config.FlinkJedisSentinelConfig;
import flinksql.connector.mredis.common.config.RedisOptions;
import flinksql.connector.mredis.common.handler.FlinkJedisConfigHandler;
...
import static flinksql.connector.mredis.descriptor.RedisValidator.REDIS_MODE;
import static flinksql.connector.mredis.descriptor.RedisValidator.REDIS_SENTINEL;
